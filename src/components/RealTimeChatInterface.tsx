      ...
      {selectedConversation ? (
        <Card className="flex-1 glass border-white/20 flex flex-col">
          ...
          <div className="p-4 border-t border-white/10">
            ...
            <p className="text-xs text-gray-500 mt-2 text-center">
              🔒 Wiadomości są szyfrowane end-to-end i automatycznie usuwane po 24 godzinach
            </p>
          </div>
        </Card>
      ) : (
        <Card className="flex-1 glass border-white/20 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-400">Wybierz konwersację aby rozpocząć bezpieczny czat</p>
          </div>
        </Card>
      )}
    </div>
