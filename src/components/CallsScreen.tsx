...
const CallsScreen: React.FC = () => {
  console.log('CallsScreen: Rendering started');
  ...
  try {
    // Przykładowe dane połączeń - w przyszłości zastąpione realną funkcjonalnością
    ...
    console.log('CallsScreen: Call history loaded', { count: callHistory.length });
    ...
    const formatTimestamp = (timestamp: Date) => {
      try {
        ...
        console.error('CallsScreen: Error formatting timestamp', error);
    ...
    const handleStartChat = async (contactId: string, contactName: string) => {
      try {
        console.log('CallsScreen: Starting chat with contact:', contactId);
        ...
        console.error('CallsScreen: Error starting chat:', error);
        toast({
          title: 'Błąd',
    ...
    const handleCall = (contactId: string, contactName: string, callType: 'voice' | 'video') => {
      console.log('CallsScreen: Initiating call', { contactId, contactName, callType });
      toast({
